...
> **Note**: This is separate from GitHub Secrets, which are used only for CI/CD pipeline configuration. See [deployment-guide.md](deployment-guide.md#4-required-github-secrets-cicd-pipeline-configuration) for details.
